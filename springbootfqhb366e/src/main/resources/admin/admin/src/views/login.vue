  ...
  <div>
    <div class="container" :style='{"minHeight":"100vh","padding":"100px  180px  0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20240127/c69581b3923448a1bec896fd2013b84c.png) no-repeat","display":"flex","width":"100%","backgroundSize":"cover","justifyContent":"flex-end"}'>
      <el-form :style='{"padding":"40px 20px 20px","boxShadow":"0 1px 20px rgba( 255,  255, 255, .8)","margin":"0","borderRadius":"4px","background":"#fff","width":"400px","height":"auto"}'>
        <div v-if="true" :style='{"width":"100%","margin":"0 0 10px 0","lineHeight":"44px","fontSize":"20px","color":"#374254","textAlign":"center"}' class="title-container">数字科技风险报告管理系统登录</div>
        ...
        <div :style='{"width":"80%","margin":"20px auto","alignItems":"center","flexWrap":"wrap","display":"flex"}'>
          ...
          <el-button :style='{"cursor":"pointer","border":"0","padding":"0 24px","margin":"10px","outline":"none","color":"#fff","borderRadius":"4px","background":"rgb(15, 116, 253)","width":"auto","fontSize":"14px","height":"44px"}' type="primary" @click="register('yonghu')" class="register">注册用户</el-button>
          <el-button :style='{"cursor":"pointer","border":"0","padding":"0 24px","margin":"10px","outline":"none","color":"#fff","borderRadius":"4px","background":"rgb(15, 116, 253)","width":"auto","fontSize":"14px","height":"44px"}' type="primary" @click="register('fuzeren')" class="register">注册负责人</el-button>
        </div>
      </el-form>
