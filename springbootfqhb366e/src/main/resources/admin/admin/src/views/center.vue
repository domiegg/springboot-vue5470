  ...
  <div :style='{"padding":"30px","margin":"0"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='fuzeren'"  label="负责人账号" prop="fuzerenzhanghao">
          <el-input v-model="ruleForm.fuzerenzhanghao" readonly              placeholder="负责人账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='fuzeren'"  label="负责人姓名" prop="fuzerenxingming">
          <el-input v-model="ruleForm.fuzerenxingming"               placeholder="负责人姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='fuzeren'"  label="手机号" prop="shoujihao">
